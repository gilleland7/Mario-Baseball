...
#Route for seeing teams by name data
@app.route('/teambyname')
def get_team_by_name(name):
    api = MiddlewareAPI()
    teamData = api.get_team_by_name(name)
    team, characterValues = set_up_team(teamData, api)
...
def set_up_team(self, teamData, api):
    team = Team()
